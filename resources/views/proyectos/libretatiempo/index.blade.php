...
@section('title', 'Libreta de Tiempo')
            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><i class="fas fa-toolbox mr-2"></i>Libreta de Tiempo</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
...
@section('content')
    ...
    <div class="section-body">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card card-info">
                    ...
                    <div class="card-body">
                        @can('crear-libretatiempo')
                            <a href="{{ route('libretatiempo.create') }}" type="button" class="btn btn-primary mb-1"><i
        ...
        @include('proyectos.libretatiempo.eliminar')
    </div>
@stop
...
@section('js')
    ...
    <script>
        $('#tbmantenimiento').DataTable({
            ...
            "ajax": "{{ route('libretatiempo.index') }}",
