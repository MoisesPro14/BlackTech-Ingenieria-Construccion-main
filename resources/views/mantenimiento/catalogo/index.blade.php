            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><i class="fas fa-fw fa-share mr-2"></i>Catalogo</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                ...
                <div class="card card-info">
                    ...
                    <div class="card-header">
                        <h4 class="card-title">Listado de Catalogos</h4>
                    ...
                    <div class="card-body">
                        ...
                        @can('crear-catalogo')
                            ...
                            @include('mantenimiento.catalogo.modal.crear')
                        @endcan
                        <hr>
                            ...
                            <tbody>
                                @foreach ($catalogos as $catalogo)
                                    <tr>
                                        ...
                                        <td>{{ $catalogo->unidad }}</td>
                                        <td>{{ $catalogo->tipo->descripcion }}</td>
                                        <td>{{ $catalogo->tipo->categoria->descripcion }}</td>
                                        <td>
                                            @if ($catalogo->estado)
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                                data-target="#mostrar{{ $catalogo->id }}">
                                                <i class="fas fa-eye"></i>
                                            </button>
                                            @can('editar-catalogo')
                                                <button type="button" class="btn btn-warning btn-sm" data-toggle="modal"
                                                    data-target="#editar{{ $catalogo->id }}">
                                            ...
                                            @can('borrar-catalogo')
                                                {!! Form::open([
                                                    'method' => 'DELETE',
                                                    'route' => ['catalogos.destroy', $catalogo->id],
                                        ...
                                        @include('mantenimiento.catalogo.modal.mostrar')
                                        <!--Ventana Modal para Editar--->
                                        @include('mantenimiento.catalogo.modal.editar')
