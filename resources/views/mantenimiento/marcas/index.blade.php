...
@section('title', 'Marca de Productos')
            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><i class="fas fa-fw fa-share mr-2"></i>Marcas</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
...
@section('content')
    ...
    <div class="section-body">
        <div class="row justify-content-center">
            ...
            <!-- crud para modulo de estados de marcas de productos -->
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">

                <div class="card card-info">

                    <div class="card-header">
                        <h4 class="card-title">Listado de Marca de Productos</h4>
                    ...
                    <div class="card-body">
                        ...
                        @can('crear-marca')
                            ...
                            @include('mantenimiento.marcas.modal.crear')
                        @endcan
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                                data-target="#mostrar{{ $marca->id }}">
                                                <i class="fas fa-eye"></i>
                                            </button>
                                            @can('editar-marca')
                                                <button type="button" class="btn btn-warning btn-sm" data-toggle="modal"
                                                    data-target="#editar{{ $marca->id }}">
                                        ...
                                        @include('mantenimiento.marcas.modal.mostrar')
                                        <!--Ventana Modal para Editar--->
                                        @include('mantenimiento.marcas.modal.editar')
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
