...
@section('title', 'Estados de Obras')
                ...
                <div class="card card-info">
                    ...
                    <div class="card-body">
                        @can('crear-estado')
                            ...
                            @include('mantenimiento.estados-obra.modal.crear')
                        @endcan
                                    ...
                                    @foreach ($estados as $estado)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($estado->estado)
                                                    <span type="button"
                                                        class="btn btn-block btn-success btn-sm">Activo</span>
                                                @else
                                                    <span type="button"
                                                        class="btn btn-block btn-danger btn-sm">Inactivo</span>
                                                @endif
                                            </td>
                                            <td>
                                                @can('editar-estado')
                                                    <button type="button" class="btn btn-warning btn-sm" data-toggle="modal"
                                                        data-target="#editar{{ $estado->id }}">
                                                ...
                                                @can('borrar-estado')
                                                    {!! Form::open([
                                                        'method' => 'DELETE',
                                                        'route' => ['estados.destroy', $estado->id],
                                            ...
                                            @include('mantenimiento.estados-obra.modal.editar')
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
