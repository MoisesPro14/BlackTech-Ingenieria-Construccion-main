...
@section('title', 'Categorias de Trabajadores')
            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><i class="fas fa-fw fa-share mr-2"><a
                                    href="{{ route('mantenimiento.categoria-trabajador.index') }}"></a></i>Categoría
                            Trabajador</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
            ...
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                ...
                <div class="card card-info">
                    ...
                    <div class="card-header">
                        <h4 class="card-title">Listado de Categorias Trabajador</h4>
                    ...
                    <div class="card-body">
                        ...
                        <table id="tbmantenimiento"
                            ...
                            <tbody>
                                @foreach ($categoriatrabajadores as $categoriatrabajadore)
                                    <tr>
                                        <td>{{ $categoriatrabajadore->id }}</td>
                                        <td>{{ $categoriatrabajadore->descripcion }}</td>
                                        <td>
                                            @if ($categoriatrabajadore->estado)
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                                data-target="#mostrar{{ $categoriatrabajadore->id }}">
                                                <i class="fas fa-eye"></i>
                                            </button>
                                            @can('editar-trabajadorcategoria')
                                                <button type="button" class="btn btn-warning btn-sm" data-toggle="modal"
                                                    data-target="#editar{{ $categoriatrabajadore->id }}">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                            @endcan
                                            @can('borrar-trabajadorcategoria')
                                                {!! Form::open([
                                                    'method' => 'DELETE',
                                                    'route' => ['categoriatrabajadores.destroy', $categoriatrabajadore->id],
