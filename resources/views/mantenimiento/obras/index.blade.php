            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><i class="fas fa-fw fa-share mr-2"></i>Obras</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                ...
                <div class="card card-info">
                    ...
                    <div class="card-header">
                        <h4 class="card-title">Listado de Obras</h4>
                    ...
                    <div class="card-body">
                        ...
                        @can('crear-obra')
                            ...
                            @include('mantenimiento.obras.modal.crear')
                        @endcan
                            ...
                            <tbody>
                                @foreach ($obras as $obra)
                                    <tr>
                                        ...
                                        <td>{{ $obra->lugar }}</td>
                                        <td>{{ $obra->cliente }}</td>
                                        <td>{{ $obra->estado->descripcion }}</td>

                                        <td>
                                            <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                                data-target="#mostrar{{ $obra->id }}">
                                                <i class="fas fa-eye"></i>
                                            </button>

                                            @can('editar-obra')
                                                <button type="button" class="btn btn-warning btn-sm" data-toggle="modal"
                                                    data-target="#editar{{ $obra->id }}">
                                        ...
                                        @include('mantenimiento.obras.modal.mostrar')
                                        <!--Ventana Modal para Editar--->
                                        @include('mantenimiento.obras.modal.editar')
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
